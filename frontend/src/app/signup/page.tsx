    ...
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)] flex items-center justify-center p-6 animate-fade-in">
      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--muted)] mt-2">Join PlaySync and find your next game partner.</p>
        </div>
        ...
        <p className="text-center text-sm text-[var(--muted)] mt-8">
          Already have an account? <Link href="/login" className="text-[var(--foreground)] hover:text-[var(--accent)] transition-colors font-medium">Log in</Link>
        </p>
      </div>
    </div>
  );
